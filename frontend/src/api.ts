...
export interface ParticipantsStatus { enabled: boolean; webhook_url: string; count: number; notify_client: boolean; notify_email: string; }
...
export const api = {
  ...
  setWebhookNotify: (cid: string, d: { notify_client: boolean; notify_email: string }) =>
