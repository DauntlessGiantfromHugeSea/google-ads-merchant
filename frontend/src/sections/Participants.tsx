                  ...
                  <div style={{ marginLeft: 26, marginTop: 6 }}>
                    ...
                    <div className="field">
                      ...
                      <div className="row-inline" style={{ alignItems: "center", gap: 10 }}>
                        {status.has_logo && <img src={`${api.confirmLogoUrl(clientId)}?v=${logoV}`} alt="Logo" style={{ maxHeight: 40, maxWidth: 160, background: "linear-gradient(120deg,#242848,#5b3b8c)", borderRadius: 8, padding: "6px 10px" }} />}
